...
const libName = 'ng2wig';
const rootFolder = path.join(__dirname);
const compilationFolder = path.join(rootFolder, 'out-tsc');
const srcFolder = path.join(rootFolder, 'src');
const distFolder = path.join(rootFolder, 'dist');
const tempLibFolder = path.join(compilationFolder, 'src');
const es5OutputFolder = path.join(compilationFolder, 'es5');
const es2015OutputFolder = path.join(compilationFolder, 'es2015');
